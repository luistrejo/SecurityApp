...
public class FormularioRutinasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSig.setOnClickListener(v -> {
            ...
            DatabaseReference current_user_db = FirebaseDatabase.getInstance().getReference().child("Users").child("Customers").child(userID).child("Routines").push();
            ...
            Toast.makeText(FormularioRutinasActivity.this, "RUTINA PROGRAMADA PARA EL DIA :" + date + "\\n"
